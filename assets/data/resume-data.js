      ...
      skills: {
        ...
        items: [
          ...
          },
          {
            name: "桌面端交付与发布链路",
            level: 84,
            description: "熟悉 Rust / Tauri 构建、npm 脚本、插件处理、安装包生成、MSIX、版本号管理和会员授权校验配置，具备公司主要软件 Microsoft Store（微软商店）/ Steam 上架流程经验。"
          },
          {
        ...
        items: [
          {
            ...
            points: [
              "负责多款桌面端软件的打包、发布、检测、分发与下载链路维护，覆盖官网、CDN、对象存储等发布渠道。",
      ...
      additionalSections: [
        {
          ...
          "善于把重复性操作沉淀为 Python 脚本、批处理任务、运行检查清单和文档，减少手动操作漏点和沟通成本。"
        ]
        }
      ],
      projects: {
        ...
        items: [
          {
            name: "桌面端软件打包与发布工具链",
            stack: "Rust / Tauri / npm scripts / Python / MSIX / Cloudflare",
            badge: "构建发布 / 工具链维护",
            points: [
